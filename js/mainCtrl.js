...
app.controller('mainCtrl', function($scope, itunesService) {
    ...
    $scope.getSongData = function() {
        // console.log('ctrl', $scope.artist, $scope.kind, $scope.search);
        itunesService.getData($scope.artist, $scope.kind, $scope.search).then(function(songData) {
            // console.log('ctrl songData', songData);
